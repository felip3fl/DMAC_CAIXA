...
Begin VB.Form frmCaixaTEFPedido 
   BackColor       =   &H00000000&
   BorderStyle     =   0  'None
   Caption         =   "frmCaixaTEFPedido"
   ClientHeight    =   8745
   ClientLeft      =   2610
   ClientTop       =   1590
   ClientWidth     =   12345
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex7UCtl.VSFlexGrid grdItens 
         ...
         FormatString    =   $"frmCaixaTEFPedido.frx":0000
         ScrollTrack     =   0   'False
         ScrollBars      =   2
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmCaixaTEFPedido"
...
Private Sub Form_Load()
 ...
 Call AjustaTela(frmCaixaTEFPedido)
...
Private Sub grdItens_KeyDown(KeyCode As Integer, Shift As Integer)
  If KeyCode = vbKeyF1 Then
      If fraNFP.Visible = False And fraPedido.Visible = False Then
         ...
         frmFormaPagamento.txtIdentificadequeTelaqueveio.text = "FRMCAIXATEFPEDIDO"
