...
Begin VB.Form frmCaixaTEF 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex7UCtl.VSFlexGrid grdItens 
         ...
         FormatString    =   $"frmCaixaTEF.frx":0000
         ScrollTrack     =   0   'False
         ScrollBars      =   2
         ScrollTips      =   0   'False
         MergeCells      =   0
     ...
     Screen.MousePointer = vbNormal
      ...
      'fim josi
       ...
       Else
          ...
          wValoraPagarNORMAL = Format(frmCaixaTEF.lblTotalvenda.Caption, "###,###,##0.00")
          frmFormaPagamento.chbValoraPagar.Caption = Format(lblTotalvenda.Caption, "###,###,##0.00")
          frmFormaPagamento.txtIdentificadequeTelaqueveio.text = "FRMCAIXATEF"
