...
Begin VB.Form frmFormaPagamento 
   ...
   Begin Balcao2010.chameleonButton chbSair 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmFormaPagamento.frx":0000
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Frame fraFinanciadoFaturado 
      ...
      Begin Balcao2010.chameleonButton chbOkFat 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmFormaPagamento.frx":001C
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin Balcao2010.chameleonButton chbValoraPagarFat 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmFormaPagamento.frx":0038
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin Balcao2010.chameleonButton chbValorEntrada 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmFormaPagamento.frx":0054
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin Balcao2010.chameleonButton chbConfimaEntrada 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmFormaPagamento.frx":0070
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin VB.Frame fraNModalidades 
         ...
         Begin VB.Frame frameCartoes 
            ...
            Begin VB.CommandButton chbAmex 
               ...
               Height          =   750
               Left            =   1185
               Picture         =   "frmFormaPagamento.frx":008C
               Style           =   1  'Graphical
               TabIndex        =   53
               Top             =   0
               Width           =   1155
            ...
            Begin VB.CommandButton chbMasterCard 
               ...
               Height          =   750
               Left            =   0
               Picture         =   "frmFormaPagamento.frx":28E2
               Style           =   1  'Graphical
               TabIndex        =   52
               Top             =   0
               Width           =   1155
            ...
            Begin VB.CommandButton chbHiperCard 
               ...
               Height          =   750
               Left            =   2370
               Picture         =   "frmFormaPagamento.frx":37D7
               Style           =   1  'Graphical
               TabIndex        =   51
               Top             =   0
               Width           =   1155
            ...
            Begin VB.CommandButton chbVisa 
               ...
               Height          =   750
               Left            =   0
               Picture         =   "frmFormaPagamento.frx":4862
               Style           =   1  'Graphical
               TabIndex        =   50
               Top             =   780
               Width           =   1155
            ...
            Begin VB.CommandButton chbRedeShop 
               ...
               Height          =   750
               Left            =   3555
               Picture         =   "frmFormaPagamento.frx":7964
               Style           =   1  'Graphical
               TabIndex        =   49
               Top             =   0
               Width           =   1155
            ...
            Begin VB.CommandButton chbVisaElectron 
               ...
               Height          =   750
               Left            =   1185
               Picture         =   "frmFormaPagamento.frx":C6DA
               Style           =   1  'Graphical
               TabIndex        =   48
               Top             =   780
               Width           =   1155
            ...
            Begin Balcao2010.chameleonButton cmdTrocar 
               ...
               MCOL            =   5263440
               MPTR            =   1
               MICON           =   "frmFormaPagamento.frx":FB48
               UMCOL           =   -1  'True
               SOFT            =   0   'False
               PICPOS          =   0
               NGREY           =   0   'False
         ...
         Begin VB.CommandButton chbCielo 
            Appearance      =   0  'Flat
            BackColor       =   &H00FFC0C0&
            DownPicture     =   "frmFormaPagamento.frx":FB64
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
            ...
            Height          =   750
            Left            =   2370
            Picture         =   "frmFormaPagamento.frx":10ABF
            Style           =   1  'Graphical
            TabIndex        =   46
            Top             =   825
            Width           =   2340
