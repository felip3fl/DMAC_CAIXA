...
Begin VB.Form frmFormaPagamento 
   ...
   Begin VB.Frame frmEstorno 
      ...
      Begin Balcao2010.chameleonButton chbEstorno 
         ...
         tx              =   "chameleonButton1"
         enab            =   -1  'True
         font            =   "frmFormaPagamento.frx":AFCC2
         coltype         =   1
         focusr          =   -1  'True
         bcol            =   14215660
         bcolo           =   14215660
         ...
         mcol            =   12632256
         mptr            =   1
         micon           =   "frmFormaPagamento.frx":AFCEE
         picn            =   "frmFormaPagamento.frx":AFD0C
         pich            =   "frmFormaPagamento.frx":B0960
         umcol           =   -1  'True
         soft            =   0   'False
         picpos          =   0
         ngrey           =   0   'False
      ...
      Begin VB.CommandButton chbDinheiroEst 
         ...
         Height          =   555
         Left            =   540
         Picture         =   "frmFormaPagamento.frx":B15B4
         Style           =   1  'Graphical
         TabIndex        =   59
         Top             =   165
         Width           =   750
      ...
      Begin VB.CommandButton chbVisaElectronEst 
         ...
         Height          =   555
         Left            =   2070
         Picture         =   "frmFormaPagamento.frx":B44D6
         Style           =   1  'Graphical
         TabIndex        =   58
         Top             =   165
         Width           =   750
      ...
      Begin VB.CommandButton chbRedeShopEst 
         ...
         Height          =   555
         Left            =   2820
         Picture         =   "frmFormaPagamento.frx":B7944
         Style           =   1  'Graphical
         TabIndex        =   57
         Top             =   165
         Width           =   750
      ...
      Begin VB.CommandButton chbVisaEst 
         ...
         Height          =   555
         Left            =   540
         Picture         =   "frmFormaPagamento.frx":BC6BA
         Style           =   1  'Graphical
         TabIndex        =   56
         Top             =   720
         Width           =   750
      ...
      Begin VB.CommandButton chbHiperCardEst 
         ...
         Height          =   555
         Left            =   2850
         Picture         =   "frmFormaPagamento.frx":BF7BC
         Style           =   1  'Graphical
         TabIndex        =   55
         Top             =   735
         Width           =   750
      ...
      Begin VB.CommandButton chbChequeEst 
         ...
         Height          =   555
         Left            =   1305
         Picture         =   "frmFormaPagamento.frx":C2636
         Style           =   1  'Graphical
         TabIndex        =   54
         Top             =   165
         Width           =   750
      ...
      Begin VB.CommandButton chbBNDESESt 
         ...
         Height          =   555
         Left            =   3600
         Picture         =   "frmFormaPagamento.frx":C5138
         Style           =   1  'Graphical
         TabIndex        =   53
         Top             =   165
         Width           =   750
      ...
      Begin VB.CommandButton chbMasterCardEst 
         ...
         Height          =   555
         Left            =   1305
         Picture         =   "frmFormaPagamento.frx":C7ABA
         Style           =   1  'Graphical
         TabIndex        =   52
         Top             =   720
         Width           =   750
      ...
      Begin VB.CommandButton chbNotaCreditoEst 
         ...
         Height          =   555
         Left            =   3615
         Picture         =   "frmFormaPagamento.frx":CA43C
         Style           =   1  'Graphical
         TabIndex        =   51
         Top             =   735
         Width           =   750
      ...
      Begin VB.CommandButton chbAmexEst 
         ...
         Height          =   555
         Left            =   2070
         Picture         =   "frmFormaPagamento.frx":CD0BE
         Style           =   1  'Graphical
         TabIndex        =   50
         Top             =   735
         Width           =   750
      ...
      Begin VB.Label Label4 
         ...
         Width           =   330
      End
      Begin VB.Label lblDestinoValor 
         BackColor       =   &H00C0FFFF&
         Caption         =   "Label3"
         ForeColor       =   &H00FF0000&
         Height          =   270
         ...
         Width           =   1350
      End
      Begin VB.Label lblOrigemEstorno 
         BackColor       =   &H00C0FFFF&
         Caption         =   "Label2"
         ForeColor       =   &H00FF0000&
         Height          =   285
   ...
   Begin VB.Frame fraNModalidades 
      ...
      Begin VB.CommandButton chbAmex 
         ...
         Height          =   750
         Left            =   2385
         Picture         =   "frmFormaPagamento.frx":CF914
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   825
         Width           =   1155
      ...
      Begin VB.CommandButton chbNotaCredito 
         ...
         Height          =   750
         Left            =   1200
         Picture         =   "frmFormaPagamento.frx":D216A
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   1605
         Width           =   1155
      ...
      Begin VB.CommandButton chbMasterCard 
         ...
         Height          =   750
         Left            =   1200
         Picture         =   "frmFormaPagamento.frx":D4DEC
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   825
         Width           =   1155
      ...
      Begin VB.CommandButton chbBNDES 
         ...
         Height          =   750
         Left            =   15
         Picture         =   "frmFormaPagamento.frx":D776E
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   1605
         Width           =   1155
      ...
      Begin VB.CommandButton chbCheque 
         ...
         Height          =   750
         Left            =   1200
         Picture         =   "frmFormaPagamento.frx":DA0F0
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   45
         Width           =   1155
      ...
      Begin VB.CommandButton chbHiperCard 
         ...
         Height          =   750
         Left            =   3570
         Picture         =   "frmFormaPagamento.frx":DCBF2
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   825
         Width           =   1155
      ...
      Begin VB.CommandButton chbVisa 
         ...
         Height          =   750
         Left            =   15
         Picture         =   "frmFormaPagamento.frx":DFA6C
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   825
         Width           =   1155
      ...
      Begin VB.CommandButton chbRedeShop 
         ...
         Height          =   750
         Left            =   3570
         Picture         =   "frmFormaPagamento.frx":E2B6E
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   45
         Width           =   1155
      ...
      Begin VB.CommandButton chbVisaElectron 
         ...
         Height          =   750
         Left            =   2385
         Picture         =   "frmFormaPagamento.frx":E78E4
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   45
         Width           =   1155
      ...
      Begin VB.CommandButton chbDinheiro 
         ...
         Height          =   750
         Left            =   15
         Picture         =   "frmFormaPagamento.frx":EAD52
         Style           =   1  'Graphical
         TabIndex        =   0
         Top             =   45
         Width           =   1155
   ...
   Begin Balcao2010.chameleonButton chbOK 
      ...
      tx              =   ""
      enab            =   -1  'True
      font            =   "frmFormaPagamento.frx":EDC74
      coltype         =   1
      focusr          =   -1  'True
      bcol            =   14933984
      bcolo           =   14933984
      ...
      mcol            =   12632256
      mptr            =   1
      micon           =   "frmFormaPagamento.frx":EDCA0
      picn            =   "frmFormaPagamento.frx":EDCBE
      pich            =   "frmFormaPagamento.frx":EE912
      umcol           =   -1  'True
      soft            =   0   'False
      picpos          =   0
      ngrey           =   0   'False
   ...
   Begin Balcao2010.chameleonButton chbTroco 
      ...
      tx              =   ""
      enab            =   -1  'True
      font            =   "frmFormaPagamento.frx":EF566
      coltype         =   2
      focusr          =   -1  'True
      bcol            =   14215660
      bcolo           =   14215660
      ...
      mcol            =   12632256
      mptr            =   1
      micon           =   "frmFormaPagamento.frx":EF592
      picn            =   "frmFormaPagamento.frx":EF5B0
      pich            =   "frmFormaPagamento.frx":F19E4
      umcol           =   -1  'True
      soft            =   0   'False
      picpos          =   0
      ngrey           =   0   'False
   ...
   Begin Balcao2010.chameleonButton chbValorFalta 
      ...
      tx              =   "0"
      enab            =   -1  'True
      font            =   "frmFormaPagamento.frx":F3E18
      coltype         =   2
      focusr          =   -1  'True
      bcol            =   16558443
      bcolo           =   16558443
      ...
      mcol            =   12632256
      mptr            =   1
      micon           =   "frmFormaPagamento.frx":F3E44
      umcol           =   -1  'True
      soft            =   0   'False
      picpos          =   0
      ngrey           =   0   'False
   ...
   Begin Balcao2010.chameleonButton chbValorPago 
      ...
      tx              =   "0"
      enab            =   -1  'True
      font            =   "frmFormaPagamento.frx":F3E62
      coltype         =   2
      focusr          =   -1  'True
      bcol            =   16558443
      bcolo           =   15002065
      ...
      mcol            =   12632256
      mptr            =   1
      micon           =   "frmFormaPagamento.frx":F3E8E
      umcol           =   -1  'True
      soft            =   0   'False
      picpos          =   0
      ngrey           =   0   'False
   ...
   Begin Balcao2010.chameleonButton chbValoraPagar 
      ...
      tx              =   "0"
      enab            =   -1  'True
      font            =   "frmFormaPagamento.frx":F3EAC
      coltype         =   2
      focusr          =   -1  'True
      bcol            =   16558443
      bcolo           =   16558443
      ...
      mcol            =   12632256
      mptr            =   1
      micon           =   "frmFormaPagamento.frx":F3ED8
      umcol           =   -1  'True
      soft            =   0   'False
      picpos          =   0
      ngrey           =   0   'False
   ...
   Begin Balcao2010.chameleonButton chbSair 
      ...
      tx              =   ""
      enab            =   -1  'True
      font            =   "frmFormaPagamento.frx":F3EF6
      coltype         =   1
      focusr          =   -1  'True
      bcol            =   14933984
      bcolo           =   14933984
      ...
      mcol            =   12632256
      mptr            =   1
      micon           =   "frmFormaPagamento.frx":F3F22
      picn            =   "frmFormaPagamento.frx":F3F40
      pich            =   "frmFormaPagamento.frx":F4794
      umcol           =   -1  'True
      soft            =   0   'False
      picpos          =   0
      ngrey           =   0   'False
      ...
      value           =   0   'False
   End
   Begin Balcao2010.chameleonButton chbteste1 
      Height          =   525
      Left            =   3030
      TabIndex        =   67
      Top             =   3585
      ...
      tx              =   "0"
      enab            =   -1  'True
      font            =   "frmFormaPagamento.frx":F4FE8
      coltype         =   2
      focusr          =   -1  'True
      bcol            =   16558443
      bcolo           =   15002065
      ...
      mcol            =   12632256
      mptr            =   1
      micon           =   "frmFormaPagamento.frx":F5014
      umcol           =   -1  'True
      soft            =   0   'False
      picpos          =   0
      ngrey           =   0   'False
...
Dim wEstornoTEFVisaElectron As String
Dim wEstornoTEFRedeShop As String
Dim wEstornoTEFHiperCard As String


Dim wTemTEFVisaElectron As Boolean
Dim wTemTEFRedeShop As Boolean
Dim wTemTEFHiperCard As Boolean
...
wValorModalidadeIncorreto = False
      ...
      If Trim(txtValorModalidade.Text = "") Or Trim(txtValorModalidade.Text = ",") Then
         Exit Sub
      End If
           ...
           ' End If
            ...
            If lblModalidade.Caption = "CHEQUE" Then
               ValCheque = ValCheque + Val(ConverteVirgula(Format(txtValorModalidade.Text, "0.00")))
               If Val(ConverteVirgula(Format(ValCheque, "0.00"))) < Val(ConverteVirgula(Format(txtValoraPagar.Text, "0.00"))) Or _
                  Val(ConverteVirgula(Format(ValCheque, "0.00"))) = Val(ConverteVirgula(Format(txtValoraPagar.Text, "0.00"))) Then
                  TotPagar = TotPagar + Modalidade
            ...
            If lblModalidade.Caption = "VISA" Or lblModalidade.Caption = "MASTERCARD" Or _
               lblModalidade.Caption = "AMEX" Or lblModalidade.Caption = "DINNERS" Then
                  ...
                  If lblModalidade.Caption = "DINNERS" Then
                  ...
                  If ValorPagamentoCartao < Val(ConverteVirgula(Format(txtValoraPagar.Text, "0.00"))) Or _
                     ...
                     'Pagto pode ser efetuado
                     TotPagar = TotPagar + Modalidade
                  Else
                     'Pagto não pode ser efetuado
          ...
          '  End If
            ...
            End If
'-- aonde esta o troco
            txtValorTroco.Text = Val(ConverteVirgula(Format(TotPagar, "0.00"))) - _
            Val(ConverteVirgula(Format(txtValoraPagar.Text, "0.00")))
            
            txtValorTroco.Text = Format(txtValorTroco.Text, "##,###0.00")
            chbteste1.Caption = Format(txtValorTroco.Text, "##,##0.00")
            ...
            If txtValorTroco.Text > 0 Then
              ' txtNaotemtroco.Visible = False
               ...
               chbteste1.Caption = Format(txtValorTroco.Text, "##,##0.00")
               'chbValorPago.Caption = Format(txtValorTroco.Text, "##,##0.00")
               chbteste1.Visible = True
            End If
...
'-- aonde esta o troco
            ...
            If txtValorTroco.Text > 0 Then
             ...
             '  txtValorTroco.Visible = True
               chbteste1.Caption = txtValorTroco.Text
               chbteste1.Visible = True
            End If
            If txtValorTroco.Text > ValDinheiro Then
               MsgBox "O valor do troco não poderá ser maior que o valor pago em dinheiro"
...
Private Sub SubtraiValor()
   
   'Esta rotina subtrai os valores deixando a posicao dos pagamentos OK quando der alguma critica de
   ' valor de troco maior que o valor em dinheiro ou valor cheque maior que valor do pedido ou valor
   ' cartao maior que o valor do pedido
...
If wControle = "De" Then
   lblOrigemEstorno = "AMEX"
Else
   lblDestinoValor = "AMEX"
   txtEstorno.SetFocus
End If
...
If wControle = "De" Then
   lblOrigemEstorno = "BNDES"
Else
   lblDestinoValor = "BNDES"
   txtEstorno.SetFocus
End If
...
If wControle = "De" Then
   lblOrigemEstorno = "CHEQUE"
Else
   lblDestinoValor = "CHEQUE"
   txtEstorno.SetFocus
End If
...
If wControle = "De" Then
   lblOrigemEstorno = "DINHEIRO"
Else
   lblDestinoValor = "DINHEIRO"
   txtEstorno.SetFocus
End If
...
If lblOrigemEstorno = "DINHEIRO" Then
   If txtEstorno.Text > ValDinheiro Then
      wControlaEstorno = True
   End If
End If

If lblOrigemEstorno = "CHEQUE" Then
   If txtEstorno.Text > ValCheque Then
      wControlaEstorno = True
   End If
End If

If lblOrigemEstorno = "TEF" Then
   If wEstornoTEFVisaElectron = "0401" Then
      If txtEstorno.Text > ValTEFVisaElectron Then
         wControlaEstorno = True
      End If
   End If
   If wEstornoTEFRedeShop = "0402" Then
      If txtEstorno.Text > ValTEFRedeShop Then
         wControlaEstorno = True
      End If
   End If

   If wEstornoTEFHiperCard = "0403" Then
      If txtEstorno.Text > ValTEFHiperCard Then
         wControlaEstorno = True
      End If
   End If
End If
...
'If lblOrigemEstorno = "BNDES" Then
'   If txtEstorno.Text > ValBNDES Then
'      wControlaEstorno = True
'   End If
'End If

If lblOrigemEstorno = "Visa" Then
   If txtEstorno.Text > ValCartaoVisa Then
      wControlaEstorno = True
   End If
End If

If lblOrigemEstorno = "MasterCard" Then
   If txtEstorno.Text > ValCartaoMastercard Then
      wControlaEstorno = True
   End If
End If

If lblOrigemEstorno = "Amex" Then
   If txtEstorno.Text > ValCartaoAmex Then
      wControlaEstorno = True
   End If
End If


If lblOrigemEstorno = "NotaCredito" Then
   If txtEstorno.Text > ValTEFHiperCard Then
      wControlaEstorno = True
   End If
End If
...
'Retorno = Bematech_FI_EstornoFormasPagamento(lblOrigemEstorno.Caption, lblDestinoValor.Caption, txtEstorno.Text)
'Retorno = Bematech_FI_EstornoFormasPagamento("DINHEIRO", "AMEX", "40,00")
...
'iRetorno = Bematech_FI_EstornoNaoFiscalVinculadoMFD("050.961.438-80", "Sidney", "R. dos testes, 1000")

Call VerificaRetornoImpressora("", "", "Estorno")

 lblOrigemEstorno.Caption = ""
 lblDestinoValor.Caption = ""

End Sub
Private Sub EstornaValorModalidade()
   
   'Esta parte da rotina Estorna valor da modalidade desejada.
   
   'TotPagar = TotPagar - txtEstorno.Text
   
   If lblOrigemEstorno.Caption = "VISA" Then
      ValorPagamentoCartao = ValorPagamentoCartao - txtEstorno.Text
      ValCartaoVisa = ValCartaoVisa - Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
   End If
   
   If lblOrigemEstorno.Caption = "MASTERCARD" Then
      ValorPagamentoCartao = ValorPagamentoCartao - txtEstorno.Text
      ValCartaoMastercard = ValCartaoMastercard - Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
   End If
   
   If lblOrigemEstorno.Caption = "AMEX" Then
      ValorPagamentoCartao = ValorPagamentoCartao - txtEstorno.Text
      ValCartaoAmex = ValCartaoAmex - Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
   End If
                  
   If lblOrigemEstorno.Caption = "DINNERS" Then
      ValorPagamentoCartao = ValorPagamentoCartao - txtEstorno.Text
      ValCartaoDiners = ValCartaoDiners - Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
   End If


   If lblOrigemEstorno.Caption = "TF" Then
      If wTEFVisaElectron = "0401" Then
         ValTEFVisaElectron = ValTEFVisaElectron - Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
      End If
            
      If wTEFRedeShop = "0402" Then
         ValTEFRedeShop = ValTEFRedeShop - Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
      End If
      
      If wTEFHiperCard = "0403" Then
         ValTEFHiperCard = ValTEFHiperCard - Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
      End If
   End If
   
 '  If lblOrigemEstorno.Caption = "BNDES" Then
 '     ValorPagamentoCartao = ValorPagamentoCartao - txtEstorno.Text
 '     ValCartaoBNDES = ValCartaoBNDES - Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
 '  End If
      
   If lblOrigemEstorno.Caption = "DINHEIRO" Then
      ValDinheiro = ValDinheiro - Format(CDbl(txtEstorno.Text), "##,###0.00")
   End If
            
   If lblOrigemEstorno.Caption = "NOTA DE CRÉD." Then
      ValNotaCredito = ValNotaCredito - Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
   End If
           
  If lblOrigemEstorno.Caption = "CHEQUE" Then
     ValCheque = ValCheque - Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
  End If
           
   'Esta parte da rotina adiciona o valor estornado na outra modalidade desejada.
  
   If lblDestinoValor.Caption = "VISA" Then
      ValorPagamentoCartao = ValorPagamentoCartao + txtEstorno.Text
      ValCartaoVisa = ValCartaoVisa + Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
   End If
   
   If lblDestinoValor.Caption = "MASTERCARD" Then
      ValorPagamentoCartao = ValorPagamentoCartao + txtEstorno.Text
      ValCartaoMastercard = ValCartaoMastercard + Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
   End If
   
   If lblDestinoValor.Caption = "AMEX" Then
      ValorPagamentoCartao = ValorPagamentoCartao + txtEstorno.Text
      ValCartaoAmex = ValCartaoAmex + Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
   End If
                  
   If lblDestinoValor.Caption = "DINNERS" Then
      ValorPagamentoCartao = ValorPagamentoCartao + txtEstorno.Text
      ValCartaoDiners = ValCartaoDiners + Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
   End If
  ...
  ' End If
   ...
   If lblDestinoValor.Caption = "DINHEIRO" Then
      ValDinheiro = ValDinheiro + Format(CDbl(txtEstorno.Text), "##,###0.00")
   End If
            
   If lblDestinoValor.Caption = "NOTA DE CRÉD." Then
      ValNotaCredito = ValNotaCredito + Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
   End If
           
  If lblDestinoValor.Caption = "CHEQUE" Then
     ValCheque = ValCheque + Val(ConverteVirgula(Format(txtEstorno.Text, "0.00")))
  End If
...
If wControle = "De" Then
   lblOrigemEstorno = "TEF"
Else
   lblDestinoValor = "TEF"
   txtEstorno.SetFocus
End If

wEstornoTEFHiperCard = "0403"
...
If wControle = "De" Then
   lblOrigemEstorno = "MASTERCARD"
Else
   lblDestinoValor = "MASTERCARD"
   txtEstorno.SetFocus
End If
...
If wControle = "De" Then
   lblOrigemEstorno = "NOTA DE CRÉD."
Else
   lblDestinoValor = "NOTA DE CRÉD."
   txtEstorno.SetFocus
End If
...
Private Sub GravaMovimentoCaixa()
        ...
        Wecf = GLB_ECF
         ...
         If PegaLoja.EOF = False Then
              ...
              'If wTEFVisaElectron = "0401" Then
               If wTemTEFVisaElectron = True Then
                  wTemTEFVisaElectron = False
              ...
              'If wTEFRedeShop = "0402" Then
              If wTemTEFRedeShop = True Then
                  wTemTEFRedeShop = False
             ...
             'If wTEFHiperCard = "0403" Then
              If wTemTEFHiperCard = True Then
                  wTemTEFHiperCard = False
...
Private Sub chbTesteEstorno1_Click()
iRetorno = Bematech_FI_EstornoNaoFiscalVinculadoMFD("050.961.438-80", "Sidney", "R. dos testes, 1000")
Call VerificaRetornoImpressora("", "", "Estorno")
...
If wControle = "De" Then
   lblOrigemEstorno = "VISA"
Else
   lblDestinoValor = "VISA"
   txtEstorno.SetFocus
End If
...
Private Sub txtEstorno_KeyPress(KeyAscii As Integer)
If KeyAscii = 27 Then
    frmEstorno.Visible = False
    lblOrigemEstorno.Caption = ""
    lblDestinoValor.Caption = ""
    txtEstorno.Text = ""
End If
